...
/**
 * Downscale a photo (if large) and re-encode as JPEG so the base64 payload
 * stays comfortably under Vercel's serverless request-body limit. Falls back to
 * the original file's bytes if the browser can't decode/encode the image.
 */
